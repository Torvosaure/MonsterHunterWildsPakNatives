...
class ChatManager
{
  public:
    ...
    void req_add_chat_infomation(SystemString *txt) const;
  ...
  private:
    ...
    void process_skill(SystemString *obj, const bool is_on) const;
    SystemString *get_message_by_name(SystemString *name) const;
};
